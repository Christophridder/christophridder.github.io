...
\IfFileExists{mhchem.sty}{\usepackage[version=4]{mhchem}}{\providecommand{\ce}[1]{\mathrm{##1}}}\usepackage{tikz}\usepackage{titlesec}\usepackage{float}\usepackage{booktabs}
