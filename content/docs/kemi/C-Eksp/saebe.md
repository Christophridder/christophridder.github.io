...
1. Forklar, hvordan en sæbe virker. (Se gerne forsøgets video.) Brug begreberne **hydrofil**, **hydrofob**, **elektronegativitet** og **sæbeion**. Lav en tegning, hvor du viser noget fedt, du skal fjerne fra en overflade. Find din egen måde at tegne sæbeionerne på.
2. I forsøget skal du fremstille en sæbe af kokosfedt (palmin) eller tidselolie og NaOH (natriumhydroxid), som er en stærk base. Find strukturformlerne for triglyceriderne kokosfedt og tidselolie på nettet. Beskriv formlerne, og beskriv forskellene.
...
![Materialer til sæbefremstilling](images/saebe_materialer.png)
...
3. Når alt NaOH er opløst, tilsættes 7 g ethanol (husholdningssprit).
4. Hæld NaOH-opløsningen i fedtstofferne. Rør rundt med svag varme, indtil pH-værdien er på 10 eller derunder, og sæben har cremet konsistens. Det tager ca. ¾ time. Jo længere tid sæben kan røres, desto mildere bliver den; jo kortere modningstid, jo … *(overvej selv)*.
