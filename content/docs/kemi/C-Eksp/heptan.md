...
$$\text{C}_7\text{H}_{16} + \text{Br}_2 \xrightarrow{\text{lys}} \text{C}_7\text{H}_{15}\text{Br} + \text{HBr}$$
...
$$\text{Ag}^+\text{(aq)} + \text{Br}^-\text{(aq)} \rightarrow \text{AgBr(s)} \quad (\text{lysegult bundfald})$$
...
- Heptan, C₇H₁₆
- Bromvand (mættet opløsning af Br₂ i vand)
- Sølvnitratopløsning, AgNO₃ (0,10 M)

> ⚠️ **Sikkerhed:** Kittel og briller. Både heptan og bromvand håndteres i **stinkskab / under udsug**. Heptan er brandfarligt — hold det væk fra åben ild. Bromvand er ætsende og giftigt. Hav prop i reagensglasset, når det flyttes. Affald i dunken til **organisk affald**.
...
3. Hvad viser forskellen mellem det indpakkede og det belyste glas? Hvilken rolle spiller lyset?
