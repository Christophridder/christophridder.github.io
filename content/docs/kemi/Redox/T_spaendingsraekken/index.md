---
title: "T_spændingsrækken"
weight: 3
pdf: "pdfs/T_spaendingsraekken.pdf"
geometry:
  - top=2cm
  - bottom=2cm
  - left=2.5cm
...
![Spændingsrækken: uædle metaller til venstre afgiver elektroner til ædlere metaller til højre, med eksempel Na(s) + Ag+(aq) -> Na+(aq) + Ag(s)](spaendingsraekken.png)
