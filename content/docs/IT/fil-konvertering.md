...
For md --> pdf brug [pandoc]({{< relref "pandoc" >}})

### NBconvert: Jupyter filer til HTML, pdf, latex, markdown
...
## pandoc lave pdffer fra md 
- pandoc fil.md -o fil.pdf
- pandoc fil.md -o fil.docx

nedenstående giver bedre æåø support
